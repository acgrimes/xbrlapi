...
public interface Fragment extends XML {
     ...
     * @throws XBRLException if the URI is not available.
     */
     ...
     * @throws XBRLException if locators not found.
     */
     ...
     * @throws XBRLException if the ID cannot be added.
     */
     ...
     * in the fragment.
     */
    public String getNamespace() throws XBRLException;
     ...
     * @throws XBRLException
     */
    public List<LabelResource> getLabelsWithResourceRole(String resourceRole) throws XBRLException;
     ...
     * @throws XBRLException
     */
    public List<LabelResource> getLabels(List<String> languages, List<String> labelRoles) throws XBRLException;
    ...
    public List<LabelResource> getLabels(List<String> languages,
            List<String> labelRoles, List<String> linkRoles) throws XBRLException;    
     ...
     * @throws XBRLException
     */
    public List<LabelResource> getLabelsWithLanguageAndResourceRole(String language, String role) throws XBRLException;
     ...
     * @throws XBRLException
     */
    public List<LabelResource> getLabelsWithLanguageAndResourceRoleAndLinkRole(String language, String resourceRole, String linkRole) throws XBRLException;    
     ...
     * @see Language for details of these objects.
