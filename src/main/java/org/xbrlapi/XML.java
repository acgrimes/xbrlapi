...
public abstract interface XML extends Comparable<XML>, Serializable {
     ...
     * @throws XBRLException if the index is null or an empty string.
     */
     ...
     * @throws XBRLException If the attribute cannot be removed
     */
     ...
     * @throws XBRLException If there is not child element.
     */
