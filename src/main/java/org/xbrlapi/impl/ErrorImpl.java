...
public class ErrorImpl extends XMLImpl implements Error {
    ...
    /**
     * @see Error#setProblemIndex(String)
     */
    ...
    /**
     * @see Error#setExplanation(String)
     */
