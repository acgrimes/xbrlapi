...
public class LinkbaseImpl extends FragmentImpl implements Linkbase  {
     ...
     * @see Linkbase#getArcroleRef(String)
     */
     ...
     * @see Linkbase#getRoleRef(String)
     */
    ...
    /**
     * @see Linkbase#getExtendedLinks(QName)
     */
     ...
     * @throws XBRLException
     * @see Linkbase#getDocumentations()
     */
     ...
     * @throws XBRLException
     * @see Linkbase#removeDocumentation(Fragment)
     */
