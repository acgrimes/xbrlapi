...
public class TypeDeclarationImpl extends SchemaDeclarationImpl implements TypeDeclaration {	
    ...
    /**
     * @see TypeDeclaration#isFinalForExtension()
     */
    ...
    /**
     * @see TypeDeclaration#isFinalForRestriction()
     */
    ...
    /**
     * @see TypeDeclaration#isDerivedFrom(String, String)
     */
    public boolean isDerivedFrom(String namespace, String name) throws XBRLException {
    ...
    /**
     * @see TypeDeclaration#getParentType()
     */
    public TypeDeclaration getParentType() throws XBRLException {
        String parentNamespace = this.getParentTypeNamespace();
    ...
    /**
     * @see TypeDeclaration#getParentTypeLocalname()
     */
    ...
    /**
     * @see TypeDeclaration#getParentTypeNamespace()
     */
    public String getParentTypeNamespace() throws XBRLException {
        Element derivation = this.getDerivation();
        if (derivation == null) throw new XBRLException("Type " + getIndex() + " is not derived from another. It is in " + getTargetNamespace());
        if (derivation.hasAttribute("base")) {
            String qname = derivation.getAttribute("base");
            String namespace = this.getNamespaceFromQName(qname,derivation);
            return namespace;
        }
