...
public class UnitImpl extends FactDimensionContainerImpl implements Unit {
    ...
    /**
     * @see Unit#getResolvedNumeratorMeasures()
     */
    ...
    /**
     * @see Unit#getResolvedDenominatorMeasures()
     */
     ...
     * @see Unit#getDenominatorMeasures()
     */
