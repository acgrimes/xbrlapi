...
class XlinkImpl extends FragmentImpl implements Xlink {
    ...
    /**
     * @see Xlink#getAttribute(String, String)
     */
    public String getAttribute(String namespace, String localname) throws XBRLException {
