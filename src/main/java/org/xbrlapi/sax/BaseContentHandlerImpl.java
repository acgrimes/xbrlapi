...
public class BaseContentHandlerImpl extends DefaultHandler implements ContentHandler {
    ...
    /**
     * @see ContentHandler#setLoader(Loader)
     */
	...
	/**
	 * @see ContentHandler#error(SAXParseException)
	 */
	@Override
...
/*        if (exception.getMessage().contains("Cannot find the declaration of element"))
    ...
    /**
     * @see ContentHandler#fatalError(SAXParseException)
     */
   @Override
    ...
    /**
     * @see ContentHandler#warning(SAXParseException)
     */
   @Override
